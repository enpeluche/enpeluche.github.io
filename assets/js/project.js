...
/**
 * <h1 id="project-title">Réduction de réseaux : Adaptations d’idées provenant du cas polynomial au cas entier.</h1>
...
<div class="resume">
    ...
    <div class="meta-grid">
        ...
        <div>
            ...
            <span>LIRMM / Université de Montpellier</span>
        </div>
        <div>
            <strong class="keyword-item">Période</strong>
            <span>Fevrier 2025 - Juin 2025</span>
        </div>
    ...
    <div class="meta-grid">
        ...
        <div>
            <strong class="keyword-item">Liens</strong>
            <div style="display: flex; flex-direction: row;">
                <div class="github-link">
                    <a href="https://github.com/Crowreed/lattice-reduction-internship" target="_blank" rel="noopener noreferrer"><img src="/assets/img/github/github-mark-white.svg"></a>
                </div>

                <div style=" width: 2rem; height: 2rem; display: flex;flex-direction: column;align-items: center;justify-content: center;">
                    <a
                    href="https://github.com/Crowreed/lattice-reduction-internship/blob/main/report/PDF/report.pdf"
                    target="_blank"
                    download
                    style="
    ...
    <div>
        ...
        <span class="tech-tag">SageMath</span>
        <span class="concept-tag">Algorithmique</span>
        <span class="concept-tag">Réduction de réseau</span>
        <span class="concept-tag">Algebre lineaire</span>
    </div>
</div>

<a href="0-introduction/" target="_blank" rel="noopener noreferrer" class="lecture">
    Accéder au cours !
</a>
 */